...
public class ShareEngineTest {
    ...
    public void testGenerateShareOrdersDifferentCustomers() {
        ...
        assertEquals(750, result[0].getShares());

        assertEquals(123, result[1].getCustomerId());
        assertEquals(3500, result[1].getShares());
    ...
    private Payment createPayment(int customerId, int amount) {
        ...
        payment.setAmountAfterFee(new BigDecimal(amount));
        return payment;
    }
